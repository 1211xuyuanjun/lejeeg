...
from data_number import SUBSET_VAL, SUBSET_TRAIN
...
class EEGDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            raise IndexError(f"IndexError: b_rec={b_rec}, rec={rec}, stats shape={self.stats.shape if hasattr(self.stats, 'shape') else len(self.stats)}")
...
def get_train_val_loaders(
    ...
    recordings_path = pjoin(args.data.path, "recordings/data")
    ...
    csv_stats = _read_csv(pjoin(csv_path, "df_stats.csv"))
